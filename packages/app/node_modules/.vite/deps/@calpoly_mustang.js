...
var FormElement$1 = (_a = class extends HTMLElement {
  constructor() {
    super();
    this._state = {};
...
var _FormElement = class _FormElement2 extends HTMLElement {
  constructor() {
    ...
    shadow(this).template(_FormElement2.template);
    if (this.form) {
      this.form.addEventListener("submit", (event2) => {
        event2.preventDefault();
...
var t = globalThis;
var e$1 = t.ShadowRoot && (void 0 === t.ShadyCSS || t.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype;
var s = Symbol();
...
var r$3 = (t2) => new n$3("string" == typeof t2 ? t2 : t2 + "", void 0, s);
var i$1 = (t2, ...e2) => {
...
var c$2 = e$1 ? (t2) => t2 : (t2) => t2 instanceof CSSStyleSheet ? ((t3) => {
  let e2 = "";
  for (const s2 of t3.cssRules) e2 += s2.cssText;
  return r$3(e2);
})(t2) : t2;
var { is: i, defineProperty: e, getOwnPropertyDescriptor: r$2, getOwnPropertyNames: h$2, getOwnPropertySymbols: o$1, getPrototypeOf: n$2 } = Object;
var a = globalThis;
var c$1 = a.trustedTypes;
var l = c$1 ? c$1.emptyScript : "";
...
var f$2 = (t2, s2) => !i(t2, s2);
var y = { attribute: true, type: String, converter: u, reflect: false, hasChanged: f$2 };
...
var n$1 = globalThis;
var c = n$1.trustedTypes;
var h$1 = c ? c.createPolicy("lit-html", { createHTML: (t2) => t2 }) : void 0;
var f$1 = "$lit$";
...
var P = (t2) => (i2, ...s2) => ({ _$litType$: t2, strings: i2, values: s2 });
var ke = P(1);
...
var B = class _B {
  constructor({ strings: t2, _$litType$: i2 }, s2) {
    ...
    if (this.el = _B.createElement(l2, s2), I.currentNode = this.el.content, 2 === i2 || 3 === i2) {
...
var et = class _et {
  ...
  k(t2) {
    ...
    const i2 = this._$AH;
    let s2, e2 = 0;
    for (const h2 of t2) e2 === i2.length ? i2.push(s2 = new _et(this.O(lt()), this.O(lt()), this, this.options)) : s2 = i2[e2], s2._$AI(h2), e2++;
...
var Re = n$1.litHtmlPolyfillSupport;
...
var o = { attribute: true, type: String, converter: u, reflect: false, hasChanged: f$2 };
var r$1 = (t2 = o, e2, r2) => {
...
var _Switch = class _Switch2 extends h {
...
var _DropdownElement = class _DropdownElement2 extends HTMLElement {
  constructor() {
    super();
    shadow(this).template(_DropdownElement2.template);
    if (this.shadowRoot) {
...
var _InputArrayElement = class _InputArrayElement2 extends HTMLElement {
  constructor() {
    super();
    this._array = [];
    shadow(this).template(_InputArrayElement2.template).styles(_InputArrayElement2.styles);
